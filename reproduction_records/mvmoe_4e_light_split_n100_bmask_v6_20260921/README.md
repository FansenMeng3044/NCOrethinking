# MVMoE/4E-L-Split n=100 reproducibility record

This directory archives the completed B-mask v6 training run and its official
MVMoE evaluations. B-mask v6 retains the same model and constraint
factorization as B-mask v5 while using a global training batch size of 256 for
higher throughput. The policy uses the original five-dimensional static node
...
- Global training batch size: 256
- Seed: 2023
...
The metrics file contains 405,019 records, including 395,000 batch records and
...
Split successes were 12,666/16,000 at n=50, 12,112/16,000 at n=100, and
12,003/16,000 at n=200. All 6,000 instances from the six training variants were
